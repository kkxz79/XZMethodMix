...
STRING_SYMBOL_FILE="$PROJECT_DIR/XZMethodMix/Resource/func.list"

CONFUSE_FILE="$PROJECT_DIR/XZMethodMix"

HEAD_FILE="$PROJECT_DIR/XZMethodMix/Resource/codeObfuscation.h"
...
touch $HEAD_FILE
echo "#ifndef XZMethodMix_codeObfuscation_h"
